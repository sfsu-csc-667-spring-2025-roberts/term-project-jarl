...
// Remove the line that tries to instantiate GameModel as a class
// const gameModel = new GameModel(db);  // Remove this line
router.post("/test", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Use db.none for queries that don't return data
        yield connection_1.default.none("INSERT INTO test_table (test_string) VALUES ($1)", [
...
router.get("/games", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    response.render("test/games");
}));
router.get("/games/test-user", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield connection_1.default.one("INSERT INTO users (email, password) VALUES ($1, $2) RETURNING user_id", [`${crypto_1.default.randomUUID()}@example.com`, yield bcrypt_1.default.hash("password", 10)]);
    response.json({ user });
}));
router.get("/games/create", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const { gameName, max_players, created_by } = request.body;
    try {
        // Use GameModel directly instead of gameModel instance
        const game = yield game_1.default.create(gameName, max_players, created_by);
...
router.post("/games/join", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const { gameId, userId, seat_position } = request.body;
    try {
        // Use GameModel directly instead of gameModel instance
        const result = yield game_1.default.addPlayer(parseInt(gameId, 10), parseInt(userId, 10), parseInt(seat_position, 10));
