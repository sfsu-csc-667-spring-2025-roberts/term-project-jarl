  ...
  function updateGameLobbyUI(game) {
    ...
    if (playersListElement) {
      ...
      game.players.forEach((player) => {
        ...
        // Mark the creator
        if (
          playerId.toString() === game.createdBy.toString() ||
          (game.createdBy._id &&
            playerId.toString() === game.createdBy._id.toString())
        ) {
          li.textContent += " (Host)";
        }
  ...
  function updateGameUI(game) {
    ...
    if (roundInfoElement) {
      ...
      roundInfoElement.textContent =
        "Round: " + (roundMap[game.round] || game.round);
    }
    ...
    if (turnIndicatorElement && game.currentTurn) {
      ...
      turnIndicatorElement.textContent = isMyTurn
        ? "Your turn!"
