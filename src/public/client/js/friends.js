...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (addFriendBtn) {
        addFriendBtn.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            const friendName = prompt('Enter friend\'s username:');
            if (!friendName)
                return;
            try {
                const response = yield fetch('/friends/request', {
                    method: 'POST',
                    headers: {
    ...
    document.addEventListener('click', (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (target.classList.contains('accept-friend-btn')) {
            ...
            if (!requestId)
                return;
            try {
                const response = yield fetch('/friends/respond', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
